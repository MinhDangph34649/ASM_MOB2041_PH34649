...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String add_thanhvien = "INSERT INTO ThanhVien VALUES" +
                "(0,'Nguyễn Văn A',2000, '0123',12345)," +
                "(1,'Nguyễn Văn B',2001, '2345',21321)," +
                "(2,'Nguyễn Văn C',2002, '3456',12343)," +
                "(3,'Nguyễn Văn D',2003, '4567',34232)," +
                "(4,'Nguyễn Văn E',2004, '5678',32423)";
